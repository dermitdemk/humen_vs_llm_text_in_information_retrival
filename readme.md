...
To reproduce our results, you first need to scrape the ["Tagesschau"](www.tagesschau.de) website using the "get_tageschau_links.ipynb" file to get the data. Then you can parse the resulting data into a pandas dataframe using the "tageschau_paster.ipynb" file.  
